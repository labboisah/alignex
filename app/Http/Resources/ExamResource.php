        ...
        return [
            ...
            'subjects' => $this->whenLoaded('examSubjects', fn () => $this->examSubjects
                ...
                ->map(fn ($examSubject) => [
                    ...
                    'course_id' => data_get($examSubject->selection_rules, 'course_id') ?? $examSubject->questionBank?->course_id,
                    'module_id' => data_get($examSubject->selection_rules, 'module_id') ?? $examSubject->questionBank?->module_id,
                    'topic_ids' => data_get($examSubject->selection_rules, 'topic_ids', []),
