    ...
    public function rules(): array
    {
        return [
            ...
            'admin_email' => [
                ...
                Rule::unique(AdminRegistrationRequest::class, 'admin_email'),
            ],
            ...
            'entity_code' => [
                ...
                'max:50',
                'alpha_dash',
                Rule::unique(AdminRegistrationRequest::class, 'entity_code')->where('entity_type', $this->input('entity_type')),
                $this->entityCodeRule(),
            ],
            ...
            'entity_email' => [
                ...
                'email',
                'max:255',
                Rule::unique(AdminRegistrationRequest::class, 'entity_email'),
