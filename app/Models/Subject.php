...
#[Fillable(['owner_type', 'owner_id', 'organization_id', 'school_id', 'center_id', 'secondary_school_id', 'professional_school_id', 'cbt_center_id', 'name', 'code', 'description', 'status'])]
