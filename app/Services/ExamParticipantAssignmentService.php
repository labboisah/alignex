...
class ExamParticipantAssignmentService
{
    ...
    private function ensureCandidatesBelongToExamScope(Exam $exam, Collection $candidateIds): void
    {
        ...
        $count = Candidate::query()
            ...
            // An institution course owns the paper; its audience may span departments.
            ->when(! $exam->institution_id && $exam->department_id, fn ($query) => $query->where('department_id', $exam->department_id))
