...
export default function Modules({ professionalSchool, programmes, courses, modules, canManageStructure = true }: { professionalSchool: any; programmes: any[]; courses: any[]; modules: any[]; canManageStructure?: boolean }) {
