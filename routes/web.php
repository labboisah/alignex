...
Route::middleware(['auth', 'portal.user'])->group(function () {
    ...
    Route::delete('/admin/manage-activation/{offlineActivationCode}/devices/{activation}', [OfflineActivationCodeController::class, 'removeDevice'])
        ->middleware('role:super_admin')
        ->name('offline-activation-codes.devices.destroy');
    ...
    Route::middleware(['role:super_admin', 'permission:manageAppReleases'])->group(function (): void {
        ...
        Route::middleware(['role:super_admin', 'permission:manageReadinessPackages'])->group(function (): void {
            Route::get('/autoboot/candidates', fn () => redirect('/candidates?scope=autoboot'))->name('autoboot.candidates');
            Route::get('/autoboot/subjects', fn () => redirect('/subjects?scope=autoboot'))->name('autoboot.subjects');
            ...
            Route::post('/offline-readiness-packages/{offlineReadinessPackage}/generate-paper', [OfflineReadinessPackageController::class, 'generatePaper'])->name('offline-readiness-packages.generate-paper');
            Route::delete('/offline-readiness-packages/{offlineReadinessPackage}', [OfflineReadinessPackageController::class, 'destroy'])->name('offline-readiness-packages.destroy');
        });
    ...
    Route::middleware('role:super_admin,organization_admin,professional_school_admin,examiner,facilitator')->group(function (): void {
        ...
        Route::get('/professional-schools/{professionalSchool}/facilitators/create', [ProfessionalSchoolController::class, 'createFacilitator'])->middleware('plan.feature:facilitator_management')->name('professional-schools.facilitators.create');
        ...
        Route::get('/professional-schools/{professionalSchool}/facilitators/{facilitator}/edit', [ProfessionalSchoolController::class, 'editFacilitator'])->middleware('plan.feature:facilitator_management')->name('professional-schools.facilitators.edit');
